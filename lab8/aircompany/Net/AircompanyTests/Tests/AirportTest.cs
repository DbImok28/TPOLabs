...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void AirportContainTransportMilitaryPlanes()
        {
            Assert.IsTrue(new Airport(planes)
                .GetTransportMilitaryPlanes()
                .Exists(x => x.Type == MilitaryTypes.Transport));
        }
        ...
        {
            var planesSortedByMaxLoadCapacity = new Airport(planes).SortByMaxLoadCapacity().Planes.ToList();
